...
export function getIcons(): Icons {
  return {
    ...
    ai: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 2L2 7V12C2 16.5 4.23 20.68 7.62 23.15L12 21L16.38 23.15C19.77 20.68 22 16.5 22 12V7L12 2ZM12 4.18L20 8.36V12C20 15.75 18.2 19.08 15.63 21.02L12 19.18L8.37 21.02C5.8 19.08 4 15.75 4 12V8.36L12 4.18Z" fill="currentColor"/>
